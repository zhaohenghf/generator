...
public final class AssertUtils {
     ...
     * not null
     */
    public static String NON_NULL = "%s can't be null";
     ...
     */
    public static String NON_EMPTY = "%s can't be empty";

    /**
     * 非零？
     * not null and unequal than 0
     */
    public static String NON_ZERO = "%s can't be equal than 0";

    /**
     * 正数？
     * not null and greater than 0
     */
    public static String IS_POSITIVE = "%s must be greater than 0";

    /**
     * 非负数？
     * not null and (greater or equal than 0)
     */
    public static String NON_NEGATIVE = "%s can't be less than 0";
